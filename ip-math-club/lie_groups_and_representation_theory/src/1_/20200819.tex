\begin{document}
    \begin{definition}[位相群]
        \input{definition/def_topological_group.tex}
    \end{definition}
    ...
    \begin{proposition}
        \input{theorem/thm_topological_subgroup.tex}
    \end{proposition}
    ...
    \begin{proposition}
        \input{theorem/thm_natural_map_is_open_map.tex}
    \end{proposition}
    ...
    \begin{proposition}
        \input{theorem/thm_quotient_topological_group.tex}
    \end{proposition}
